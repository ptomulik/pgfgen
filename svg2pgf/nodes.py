...
class SVGElementNodeFactory:
    def __init__(self, parent_element_node: Optional[SVGElementNode]=None,
                 shape_node_factory: Optional[ShapeNodeFactory]=None) -> None:
...
class ShapeNodeFactory:
    def __init__(self, parent_element_node: Optional[SVGElementNode]=None) -> None:
        self.parent_element_node = parent_element_node
...
class SVGElementInfoGenerator(SVGElementNodeWrapper):
    def __init__(self, wrapped_element_node: SVGElementNode) -> None:
...
class PGFTransformcmGenerator(Generator):
    def __init__(self, svg_transform: Matrix, svg2pgf_transform: Matrix) -> None:
...
class PathNode(ShapeNode):
    def __init__(self, path: Path, parent_element_node: Optional[SVGElementNode]=None) -> None:
        ShapeNode.__init__(self)
        self.path = path
        self.parent_element_node = parent_element_node
        factory = PathSegmentNodeFactory(self)
        self.children_path_segment_nodes = list([factory.create_node(e) for e in self.path])
...
class UnsupportedSVGElementNode(SVGElementNode):
    def __init__(self, element: SVGElement, parent_element_node: Optional[SVGElementNode]=None) -> None:
...
class UnsupportedShapeNode(ShapeNode):
    def __init__(self, shape: Shape, parent_element_node: Optional[SVGElementNode]=None) -> None:
        ShapeNode.__init__(self)
        self._shape = shape
        self.parent_element_node = parent_element_node
...
class UnsupportedPathSegmentNode(PathSegmentNode):
    def __init__(self, path_segment: PathSegment, parent_path_node: Optional[PathNode]=None) -> None:
...
class CloseNode(PathSegmentNode):
    def __init__(self, close: Close, parent_path_node: Optional[PathNode]=None) -> None:
        super().__init__(parent_path_node)
        self.close = close
...
class CubicBezierNode(PathSegmentNode):
    def __init__(self, cubic_bezier: CubicBezier, parent_path_node: Optional[PathNode]=None) -> None:
        super().__init__(parent_path_node)
...
class QuadraticBezierNode(PathSegmentNode):
    def __init__(self, quadratic_bezier: QuadraticBezier, parent_path_node: Optional[PathNode]=None) -> None:
        super().__init__(parent_path_node)
...
class CircleNode(ShapeNode):
    def __init__(self, circle: Circle, parent_element_node: Optional[SVGElementNode]=None) -> None:
        ShapeNode.__init__(self)
        self.circle = circle
        self.parent_element_node = parent_element_node
...
class EllipseNode(ShapeNode):
    def __init__(self, ellipse: Ellipse, parent_element_node: Optional[SVGElementNode]=None) -> None:
        ShapeNode.__init__(self)
...
class RectNode(ShapeNode):
    def __init__(self, rect: Rect, parent_element_node: Optional[SVGElementNode]=None) -> None:
        ShapeNode.__init__(self)
        self.rect = rect
        self.parent_element_node = parent_element_node
...
class SimpleLineNode(ShapeNode):
    def __init__(self, simple_line: SimpleLine, parent_element_node: Optional[SVGElementNode]=None) -> None:
        ShapeNode.__init__(self)
...
class _PolyshapeNode(ShapeNode):
    def __init__(self, polyshape: _Polyshape, parent_element_node: Optional[SVGElementNode]=None) -> None:
        ShapeNode.__init__(self)
...
class GroupNode(SVGElementNode, SVGElementContainerNode, SVG2PGFTransform):
    def __init__(self, group: Group, parent_element_node: Optional[SVGElementNode]=None) -> None:
        SVG2PGFTransform.__init__(self)
        self.group = group
        self.parent_element_node = parent_element_node
        factory = SVGElementNodeFactory(self)
        self.children_element_nodes = list([factory.create_node(e) for e in self.element])
...
class UseNode(SVGElementNode, SVGElementContainerNode, SVG2PGFTransform):
    def __init__(self, use: Use, parent_element_node: Optional[SVGElementNode]=None) -> None:
        SVG2PGFTransform.__init__(self)
        self.use = use
        self.parent_element_node = parent_element_node
        factory = SVGElementNodeFactory(self)
...
class SymbolNode(SVGElementNode):
    def __init__(self, symbol: SVGElement, parent_element_node: Optional[SVGElementNode]=None) -> None:
        self.symbol = symbol
        self.parent_element_node = parent_element_node
...
class SVGNode(GroupNode):
    def __init__(self, svg: SVG, parent_element_node: Optional[SVGElementNode]=None) -> None:
